...
namespace LibraryAggregator.DataLayer.Migrations
{
    ...
    [Migration("20230224080232_Change4")]
            ...
            modelBuilder.Entity("LibraryAggregator.DataLayer.Entities.Booking", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ClientId = 1,
                            Code = 300166,
                            FinishDate = new DateTime(2023, 3, 3, 11, 2, 31, 989, DateTimeKind.Local).AddTicks(2505),
                            StartDate = new DateTime(2023, 2, 24, 11, 2, 31, 989, DateTimeKind.Local).AddTicks(2489)
                        });
                });
