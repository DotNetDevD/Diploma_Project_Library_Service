...
namespace LibraryAggregator.DataLayer.Migrations
{
    ...
    [Migration("20230224075534_Change2")]
            ...
            modelBuilder.Entity("LibraryAggregator.DataLayer.Entities.Booking", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ClientId = 1,
                            Code = 701657,
                            FinishDate = new DateTime(2023, 3, 3, 10, 55, 34, 257, DateTimeKind.Local).AddTicks(8968),
                            StartDate = new DateTime(2023, 2, 24, 10, 55, 34, 257, DateTimeKind.Local).AddTicks(8949)
                        });
                });
