...
namespace LibraryAggregator.DataLayer.Migrations
{
    ...
    [Migration("20230224075903_Change3")]
            ...
            modelBuilder.Entity("LibraryAggregator.DataLayer.Entities.Booking", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ClientId = 1,
                            Code = 655252,
                            FinishDate = new DateTime(2023, 3, 3, 10, 59, 2, 823, DateTimeKind.Local).AddTicks(3246),
                            StartDate = new DateTime(2023, 2, 24, 10, 59, 2, 823, DateTimeKind.Local).AddTicks(3233)
                        });
                });
