...
namespace LibraryAggregator.DataLayer.Migrations
{
    ...
    [Migration("20230224072906_fixBooking")]
            ...
            modelBuilder.Entity("LibraryAggregator.DataLayer.Entities.Booking", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ClientId = 1,
                            Code = 524666,
                            FinishDate = new DateTime(2023, 3, 3, 10, 29, 5, 968, DateTimeKind.Local).AddTicks(7410),
                            StartDate = new DateTime(2023, 2, 24, 10, 29, 5, 968, DateTimeKind.Local).AddTicks(7397)
                        });
                });
